...
export class D3chartsComponent implements OnInit {
    ...
    nodes = [{ id: 0, reflexive: false }, { id: 1, reflexive: true }, { id: 2, reflexive: false }];
    links = [
    ...
    ngAfterContentInit() {
        ...
        // app starts here
        this.svg
            .on('mousedown', (dataItem, value, source) => this.mousedown(dataItem, value, source))
